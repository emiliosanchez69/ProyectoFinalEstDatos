...
class GrafosConsola:
    ...
    def agregar_arista(self):
        try:
            print(self.term.clear())
            self.header("Opción 7 - Grafos -> Agregar destino (arista)", "")
    ...
    def calcularKruskal(self):
        ...
        print(self.term.clear())
        self.header("Opción 7 - Grafos -> Calcular costo mínimo (Kruskal)", "")
    ...
    def visualizar_grafo(self): #corregir
        print(self.term.clear())
        self.header("Opción 7 - Grafos -> Visualizar Grafo", "")
        ...
        with self.term.fullscreen(), self.term.cbreak():
            while True:
                ...
                if key.name == "KEY_DOWN":
                    ...
                    while True:
                        self.header("Opción 7: Grafos > Información", buttons="[BACKSPACE] Cerrar esta ventana")
